 ...
 */
public interface ExternalExperimentAService extends IService<ExternalExperimentAEntity> {

    PageUtils queryPage(Map<String, Object> params);

    int getCount();

    List<ExternalExperimentAEntity> searchAnyCol(String keyword, List<String> col);
