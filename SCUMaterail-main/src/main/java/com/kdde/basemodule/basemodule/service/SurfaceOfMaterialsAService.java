 ...
 */
public interface SurfaceOfMaterialsAService extends IService<SurfaceOfMaterialsAEntity> {

    PageUtils queryPage(Map<String, Object> params);

    int getCount();

    List<SurfaceOfMaterialsAEntity> searchAnyCol(String keyword, List<String> col);
