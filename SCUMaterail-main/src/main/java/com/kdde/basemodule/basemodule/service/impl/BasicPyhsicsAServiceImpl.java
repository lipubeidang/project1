...
import com.kdde.basemodule.basemodule.dao.BasicPyhsicsADao;
import com.kdde.basemodule.basemodule.entity.BasicPyhsicsAEntity;
import com.kdde.basemodule.basemodule.service.BasicPyhsicsAService;


@Service("basicPyhsicsAService")
public class BasicPyhsicsAServiceImpl extends ServiceImpl<BasicPyhsicsADao, BasicPyhsicsAEntity> implements BasicPyhsicsAService {

    @Override
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<BasicPyhsicsAEntity> page = this.page(
                new Query<BasicPyhsicsAEntity>().getPage(params),
                new QueryWrapper<BasicPyhsicsAEntity>()
        );
    ...
    @Override
    public List<BasicPyhsicsAEntity> searchAnyCol(String keyword, List<String> colName) {
        QueryWrapper<BasicPyhsicsAEntity> queryWrapper = new QueryWrapper<>();
        if(colName != null && !colName.isEmpty()){
            for (String column : colName) {
                queryWrapper.or().like(column, keyword);
            }
        }else{
            List<String> colNames = EntityColumnUtil.getTableColumns(BasicPyhsicsAEntity.class);
...
//        validateFieldNames(fieldNames);
    ...
    @Override
    public List<BasicPyhsicsAEntity> searchListBySerial(String serial) {
//        List<BasicPyhsicsAEntity>
        return null;
    }
}