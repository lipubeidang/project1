...
import com.kdde.basemodule.basemodule.dao.LiteratureSampleDao;
import com.kdde.basemodule.basemodule.entity.LiteratureSampleEntity;
import com.kdde.basemodule.basemodule.service.LiteratureSampleService;


@Service("literatureSampleService")
public class LiteratureSampleServiceImpl extends ServiceImpl<LiteratureSampleDao, LiteratureSampleEntity> implements LiteratureSampleService {

    @Override
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<LiteratureSampleEntity> page = this.page(
                new Query<LiteratureSampleEntity>().getPage(params),
                new QueryWrapper<LiteratureSampleEntity>()
        );
    ...
    @Override
    public List<LiteratureSampleEntity> searchAnyCol(String keyword, List<String> colName) {
        QueryWrapper<LiteratureSampleEntity> queryWrapper = new QueryWrapper<>();
        if(colName != null && !colName.isEmpty()){
            for (String column : colName) {
                queryWrapper.or().like(column, keyword);
            }
        }else{
            List<String> colNames = EntityColumnUtil.getTableColumns(LiteratureSampleEntity.class);
